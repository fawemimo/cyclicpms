...
INSTALLED_APPS = [
    ...
    "set_salary.apps.SetSalaryConfig",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "contacts.context_processors.email_subscriber",
                # 'dashboards.context_processor.user_country_context',
                # 'managements.context_processor.employee_context',
            ],
        },
    },
]
