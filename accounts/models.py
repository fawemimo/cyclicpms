...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, first_name, last_name, other_name, phone_number,  email,user_type, username, password=None):
...
# # Profile models for different user typ   user = models.OneToOneField(
# default=False)es 
